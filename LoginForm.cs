...
namespace Private_deliver
{
    public partial class LoginForm : Form
    {
        ...
        private void BtnLogin_Click_1(object sender, EventArgs e)
        {
            ...
            {
                case 1: // Admin
                    var formStudentsAffairs = new PrivateGradeDeliverySystem1();
                    formStudentsAffairs.Show();
                    this.Hide();
                    break;
                case 2: // Dean
                    var dean = new DeanForm();
                    dean.Show();
                    this.Hide();
                    break;
                case 3: // Lecturer
                    var lect = new LecturerForm();
                    lect.Show();
                    this.Hide();
                    break;
        ...
        private void LinkReset_Click_1(object sender, EventArgs e)
        {
            this.Hide();
